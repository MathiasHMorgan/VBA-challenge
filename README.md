...
'Loop Through Data and extract values
    ...
    For i = 2 To lastrow
       ...
       'Color Index
        ...
        'Commentary:
        'This was my attempt at the bonus section i was attempting to return the value for the bonus section
        'It appears to return errors that i am unable to resolve, althouhg i believe my logic is outlined below
...
'Final Commentary: at this stage i am able to return values for the initial worksheet but the worksheets after were not returning any values.
